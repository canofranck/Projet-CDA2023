...
public class CommentaireController {
	...
	public ResponseEntity findcommentaireById(@PathVariable(name = "id_commentaire") Long id_commentaire) {
		if (id_commentaire == null) {
			return ResponseEntity.badRequest().body("not found Commentaire by ID");
		}
	...
	public ResponseEntity<Commentaire> updateCommentaire(
			@Validated @PathVariable(name = "id_commentaire") Long id_commentaire,
			@RequestBody(required = false) Commentaire commentaire) {
		if (commentaire == null) {
			return ResponseEntity.notFound().build();
	...
	public ResponseEntity<Commentaire> deleteCommentaire(
			@Validated @PathVariable(name = "id_commentaire") Long id_commentaire) {
