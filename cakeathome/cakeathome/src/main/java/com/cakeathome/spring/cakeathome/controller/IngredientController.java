...
public class IngredientController {
	...
	public ResponseEntity findingredientrById(@PathVariable(name = "id_ingredient") Long id_ingredient) {
		if (id_ingredient == null) {
			return ResponseEntity.badRequest().body("not found Ingredient by ID");
		}
	...
	public ResponseEntity<Ingredient> updateIngredient(
			@Validated @PathVariable(name = "id_ingredient") Long id_ingredient,
	...
	public ResponseEntity<Ingredient> deleteIngredient(
			@Validated @PathVariable(name = "id_ingredient") Long id_ingredient) {
