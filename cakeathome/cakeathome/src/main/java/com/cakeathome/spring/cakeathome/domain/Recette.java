...
public class Recette implements Serializable {
	 ...
	 * 
	 * @JoinColumn(name = "id_utilisateur", nullable=false, referencedColumnName =
	 * "id_utilisateur") private Long id_utilisateur;
	 */
	...
	public Recette(Long id_recette, String titre_recette, Date date_recette, String description_recette,
			...
			boolean recettepremium_recette, Long id_utilisateur, List<Ingredient> ingredients) {
		super();
		this.id_recette = id_recette;
		this.titre_recette = titre_recette;
		this.date_recette = date_recette;
