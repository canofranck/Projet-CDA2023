...
public class AbonnementController {
	...
	public ResponseEntity findAbonnementById(@PathVariable(name = "id_abonnement") Long id_abonnement) {
		if (id_abonnement == null) {
			return ResponseEntity.badRequest().body("not found Abonnement by ID");
		}
	...
	public ResponseEntity<Abonnement> updateAbonnement(
			@Validated @PathVariable(name = "id_abonnement") Long id_abonnement,
			@RequestBody(required = false) Abonnement abonnement) {
		if (abonnement == null) {
			return ResponseEntity.notFound().build();
	...
	public ResponseEntity<Abonnement> deleteAbonnement(
			@Validated @PathVariable(name = "id_abonnement") Long id_abonnement) {
