...
public class ImageRecetteController {
	...
	public ResponseEntity findimageRecetteById(@PathVariable(name = "id_image_recette") Long id_image_recette) {
		if (id_image_recette == null) {
			return ResponseEntity.badRequest().body("not found Image recette by ID");
		}
	...
	public ResponseEntity<ImageRecette> updateImageRecette(
			@Validated @PathVariable(name = "id_image_recette") Long id_image_recette,
			@RequestBody(required = false) ImageRecette imagerecette) {
		if (imagerecette == null) {
			return ResponseEntity.notFound().build();
	...
	public ResponseEntity<ImageRecette> deleteImageRecette(
			@Validated @PathVariable(name = "id_image_recette") Long id_image_recette) {
