...
public class EtapeController {
	...
	public ResponseEntity findetapeById(@PathVariable(name = "id_etape") Long id_etape) {
		if (id_etape == null) {
			return ResponseEntity.badRequest().body("not found Etape by ID");
		}
	...
	public ResponseEntity<Etape> updateEtape(@Validated @PathVariable(name = "id_etape") Long id_etape,
			@RequestBody(required = false) Etape etape) {
		if (etape == null) {
			return ResponseEntity.notFound().build();
